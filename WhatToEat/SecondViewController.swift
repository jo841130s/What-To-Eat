...
class SecondViewController:UIViewController,UIPickerViewDelegate,UIPickerViewDataSource{
    ...
    let lunchAndDinnerArray = ["便當","義大利麵","咖哩","牛肉麵","炒麵or飯","壽司","牛排","火鍋","關東煮","丼飯","捲餅","沙拉","麥當勞","7-11","Family Mart","摩斯漢堡","漢堡王","摩斯漢堡","鐵板燒","肉羹","燒臘","港式小點","披薩","熱炒","水餃","泡麵","烤鴨","泰式","涼麵","減肥","三明治","蛋包飯","拉麵","燒烤","沙拉","麵包"]
